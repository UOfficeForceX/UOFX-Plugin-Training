const exposes = {
  web: {
    ...
    './InspectFieldComplete': './src/app/web/inspect-field-complete/inspect-field-complete.module.ts',
    './Panel/CustomerListComplete': './src/app/web/panels/user/customer-list-complete/customer-list-complete.component.ts'
  },
  app: {
    // ./Page 名稱固定，為手機端進入點
