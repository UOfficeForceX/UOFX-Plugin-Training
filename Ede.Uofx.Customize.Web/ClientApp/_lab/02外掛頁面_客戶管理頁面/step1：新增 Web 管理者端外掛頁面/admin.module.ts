...
import { PluginWebAdminCustomerManagementCompletePage } from './customer-management-complete/customer-management-complete.page';
...
import { CustomerManagementPage } from "./customer-management/customer-management.page";
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'customer-management', component: CustomerManagementPage }
    ]),
