...
import { InspectFieldCompleteExProps, InspectFieldCompleteFillModel } from '@model/inspect-field-complete.model';
...
export class InspectFieldCompleteWriteComponent extends BpmFwWriteComponent implements OnInit, OnChanges {
  ...
  /** 屬性資料 */
  @Input() exProps: InspectFieldCompleteExProps;
  /** 表單 */
  form: FormGroup;
  /** 公司ID */
  ...
  /** 設定 value 屬性 */
  value: InspectFieldCompleteFillModel;
