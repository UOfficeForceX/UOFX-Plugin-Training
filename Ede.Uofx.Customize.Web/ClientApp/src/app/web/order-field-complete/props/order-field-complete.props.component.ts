...
// TODO: import { YourExProps } from './path/to/your.model';
...
export class OrderFieldCompletePropsComponent extends BpmFwPropsComponent implements OnInit {
  ...
  // TODO: @Input() exProps: YourExProps;
  ...
  /** 初始化form */
  initForm() {
    // TODO: this.addFormControl('formControl', null, [Validators.required]);
  ...
  initExProps() {
    if (!this.exProps) {
      this.exProps = {
        // TODO: formControl: 'default value',
      };
    }
