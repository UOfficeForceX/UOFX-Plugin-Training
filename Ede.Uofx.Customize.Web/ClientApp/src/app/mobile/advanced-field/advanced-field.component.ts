...
import { AppSettings, UofxCoreDateFormatPipe } from '@uofx/app-components';
...
import { UofxFilePluginService } from "@uofx/app-components/file";
...
export class AdvancedFieldComponent extends BpmFwWriteComponent implements OnInit {
  ...
  empNo: string;
  /** 登入者公司id */
  corpId = AppSettings.UserInfo.corpId;
  /** 選人員件限制-僅選人 */
  ...
  ngOnInit(): void {
    ...
    this.form.valueChanges.subscribe({
      next: res => {
        ...
        this.selfControl.setValue(res, { emitEvent: false });
        // 使用情境說明：
